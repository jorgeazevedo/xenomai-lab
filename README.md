...
VM](https://docs.google.com/file/d/0B6ZzzSYb2RbGQWswS3V5UC1ZTnc/edit?usp=sharing) (1.5GB) instead. See guide [here](http://github.com/jorgeazevedo/xenomai-lab/wiki/How-to-use-the-VM).

### Xenomai

Xenomai Lab needs Xenomai installed on the target system. Xenomai 2.5.5.2 and 
2.5.6 are known to be supported. To install Xenomai please refer to the [how-to-page](https://github.com/jorgeazevedo/xenomai-lab/wiki/How-to-install-Xenomai)
